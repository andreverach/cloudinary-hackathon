  ...
  default: {
    es: {
      ...
      notifications: {
        ...
        no_new_files: 'Los archivos ya han sido subidos.',
        image_purchased: 'Imagen comprada',
        video_purchased: 'Video comprado',
        purchase_failed: 'La compra falló. Por favor, inténtalo de nuevo.',
        service_logged_out: 'Sesión cerrada por error del servicio',
        great: 'Genial',
        image_acquired: 'Imagen adquirida',
        video_acquired: 'Video adquirido',
        acquisition_failed:
          'La adquisición falló. Por favor, inténtalo de nuevo.',
      },
      advanced_options: {
        public_id_ph: 'ID Público',
        tags_ph: 'Agregar una etiqueta',
        add_new: 'Agregar una nueva etiqueta:',
        upload_preset_placeholder: 'Configuración de carga',
        upload_preset_no_options: 'No hay configuración de carga',
      },
      landscape_overlay: {
        title: 'El modo horizontal no es compatible',
        description:
          'Gira tu dispositivo de nuevo al modo vertical para continuar.',
      },
      aria_label: {
        close: 'Close',
        back: 'Back',
      ...
      queue: {
        title: 'Cargando cola',
        title_uploading_with_counter: 'Cargando {{num}}',
        title_processing_with_counter: 'Cargando {{num}}',
        title_uploading_processing_with_counters:
          'Cargando {{uploading}}, procesando {{processing}}',
        title_uploading: 'Cargando',
        mini_title: 'Cargado',
        ...
        mini_upload_count: '{{num}} cargado',
        mini_failed: '{{num}} error',
        statuses: {
          uploading: 'Cargando...',
          processing: 'Procesando...',
          timeout: 'Vaya esto puede tardar un poco. Se paciente.',
          error: 'Error',
          uploaded: 'Listo',
          aborted: 'Cancelado',
        },
      ...
      camera: {
        ...
        explanation: 'Dale clic en capturar',
